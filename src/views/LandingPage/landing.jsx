...
import '../PlayNow/Drawer/drawer.css';
...
import NFT from "../../images/landingImages/nft.png"
            ...
            <div  className={classes.root} >
                ...
                <div style={{backgroundColor:'black'}}>
                    <Hidden lgUp implementation="css">
                        <Grid container spacing={0} style={{padding:'8%',paddingTop:'14%'}}>
                            <Grid item xs={5}>
                    ...
                    <Grid container spacing={0}>
                        ...
                        {/* right coloumn */}
                        <Grid item xs={8} style={{paddingTop:'87px'}} >

                            {/* end first row */}
                            {/* second row */}
                            <Grid container spacing={0} style={{paddingLeft:'5px', paddingRight:'5px'}}>
                                <Grid item xs={8} >
                                    <Grid container spacing={0} style={{border:'2px solid gray',borderRadius:'15px',marginBottom:'5px'}}>
                                        <Grid item xs={12} justify="center">
                                            <img src={Hash} style={{height:'50vh'}} alt="hash raffle"/>
                                        </Grid>
                                        <Grid container spacing={0} style={{padding:'5px'}}>
                                            <Grid item xs={4} >
                                                <span><img src={one1} alt="11" style={{align:'center',height:'24vh'}}/></span>
                                            </Grid>
                                            <Grid item xs={4}>
                                                <span><img src={oneO1} alt="11" style={{height:'24vh'}}/></span>
                                            </Grid>
                                            <Grid item xs={4}>
                                                <span><img src={onek} alt="11" style={{height:'24vh'}}/></span>
                                            </Grid>
                                        </Grid>
                                    </Grid>

                                    <Grid container spacing={0} style={{color:'gray',border:'2px solid gray',borderRadius:'15px',paddingTop:'15px'}}>
                                                <Grid item xs={12}>
                                                    <Grid container spacing={0} style={{padding:'5px'}}>
                                                        <Grid item xs={4} >
                                                            <div>
                                                        ...
                                                        <Grid item xs={4}>
                                                            <span><img src={NFT} alt="11" style={{height:'8vh'}}/></span>
                                                        </Grid>
                                                    </Grid>
                                        ...
                                        <Grid item xs={4}  style={{paddingLeft:'10px',paddingTop:'5px'}}>
                                            <Hidden mdDown>
                                                <Grid container spacing={8} direction="row" style={{color:'gray',backgroundColor:'black',width:'100%',
                                                    border:'2px solid gray',borderRadius:'15px'}}
                                                >
